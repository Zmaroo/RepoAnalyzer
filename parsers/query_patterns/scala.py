...
SCALA_PATTERNS = {
    ...
    PatternCategory.LEARNING: {
        PatternPurpose.PACKAGES: {
            "package": TreeSitterAdaptivePattern(
                pattern="""
                [
                    (package_clause
...
class ScalaPatternLearner(TreeSitterCrossProjectPatternLearner):
    ...
    async def initialize(self):
        ...
        self._feature_extractor = await get_feature_extractor("scala")
...
async def process_scala_pattern(
    ...
    async with AsyncErrorBoundary(
        ...
        feature_extractor = await get_feature_extractor("scala")
