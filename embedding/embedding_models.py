...
from utils.error_handling import handle_errors, handle_async_errors, ProcessingError, ErrorBoundary, AsyncErrorBoundary
...
class BaseEmbedder:
    ...
    def _compute_embedding(self, text: str) ->np.ndarray:
        ...
        with ErrorBoundary(operation_name='embedding computation'):
